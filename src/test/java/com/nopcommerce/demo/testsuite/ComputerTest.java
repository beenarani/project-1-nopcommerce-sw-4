...
public class ComputerTest extends TestBase {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        computerPage.sendText(computerPage.firstName, "beena");
        computerPage.sendText(computerPage.lastName, "rani");
        computerPage.sendText(computerPage.emailId, "beenarani@gmail.com");
        ...
        //2.28 Fill all the details
        computerPage.sendText(computerPage.cardHolderName, "beena rani");
