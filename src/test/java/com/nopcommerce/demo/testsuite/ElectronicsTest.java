...
public class ElectronicsTest extends TestBase {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sendText(electronicsPage.firstName, "Beena");
        electronicsPage.sendText(electronicsPage.lastName, "rani");
        electronicsPage.sendText(electronicsPage.emailId, electronicsPage.generateEmailId());
        electronicsPage.select(electronicsPage.date, "12");
        electronicsPage.select(electronicsPage.month, "1");
        electronicsPage.select(electronicsPage.year, "2000");
        electronicsPage.sendText(electronicsPage.password, "beena1234");
        electronicsPage.sendText(electronicsPage.confirmPassword, "beena1234");
        //2.21 Click on “REGISTER” Button
        ...
        //2.33 Fill all the details
        electronicsPage.sendText(electronicsPage.cardHolderName, "beena rani");
